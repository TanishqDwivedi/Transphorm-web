                ...
                <div className="container my-5 py-5">
                        ...
                        <div className="col-md-4">
                            <div class="card p-3">
                                    <div class="card-body text-center">
                                        <i className="fa fa-cogs fa-4x mb-4 text-success"></i>
                                        <h5 class="card-title mb-3 fs-4 fw-bold">Highly Customizable Layout</h5>
                        ...
                        <div className="col-md-4">
                            <div class="card p-3">
                                    <div class="card-body text-center">
                                        ...
                                        <h5 class="card-title mb-3 fs-4 fw-bold">User Experiences</h5>
                                        <p class="card-text lead">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                    </div>
                            </div>
                        </div>
                    ...
                    <div className="row mt-5">
                        <div className="col-md-4">
                            <div class="card p-3">
                                    <div class="card-body text-center">
                                        ...
                                        <h5 class="card-title mb-3 fs-4 fw-bold">Creative Web Designs</h5>
                                        <p class="card-text lead">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                    </div>
                            </div>
                        </div>
                        <div className="col-md-4">
                            <div class="card p-3">
                                    <div class="card-body text-center">
                                        <i className="fa fa-file-code-o fa-4x mb-4 text-success"></i>
                        ...
                        <div className="col-md-4">
                            <div class="card p-3">
                                    <div class="card-body text-center">
                                        <i className="fa fa-star-half-o fa-4x mb-4 text-success"></i>
